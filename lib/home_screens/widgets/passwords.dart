...
class passwords extends StatefulWidget {
  const passwords({Key? key, required this.passwordData}) : super(key: key);
        ...
        itemBuilder: (context, index) {
          return InkWell(
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => passwordPage(passwordData: data[index],)),
              );
            },
            child: Padding(
                ...
                child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(flex: 1, child: InkWell( onTap: () {Clipboard.setData(ClipboardData(text: data[index]['password']));},
                        ...
                        Expanded(flex: 1, child: InkWell( onTap: () => showMaterialModalBottomSheet(
                            ...
                            builder: (context) => Stack(
                              children: <Widget>[
                                passwordSettings(passwordData: data[index],)
                              ],
                            ),
                          ),
