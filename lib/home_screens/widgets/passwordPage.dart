...
class passwordPage extends StatefulWidget {
  const passwordPage({Key? key, required this.passwordData}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('${passwordData['name']}',style: TextStyle(
                    fontFamily: 'gilroy',
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text('${passwordData['email']}', style: TextStyle(
                                        fontFamily: 'gilroy',
                                ...
                                Expanded(flex: 1, child: InkWell( onTap: () {Clipboard.setData(ClipboardData(text: passwordData['password']));},
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if(passwordVisible == true)...[
                                      Text('${passwordData['password']}', style: TextStyle(
                                        fontFamily: 'gilroy',
                                        fontWeight: FontWeight.w500,
                                        fontSize: 16,
                                        color: Color.fromRGBO(27, 27, 27, 1),
                              ...
                              if(passwordVisible == true)...[
                                Expanded(flex: 1, child: InkWell( onTap: (){
                                  setState(() {
                                    ...
                                    child: ImageIcon(AssetImage("assets/icons/eyeClose.png"), color: Color.fromRGBO(125, 125, 125, 1),))
                                ),
                              ],
                              ...
                              if(passwordVisible == false)...[
                                Expanded(flex: 1, child: InkWell( onTap: (){
                                  setState(() {
                                    ...
                                    child: ImageIcon(AssetImage("assets/icons/eye.png"), color: Color.fromRGBO(125, 125, 125, 1),))
                                ),
                              ],
