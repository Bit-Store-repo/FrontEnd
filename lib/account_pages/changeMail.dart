          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('You’ll need to verify your new email after this step',
                      style: TextStyle(
                          fontFamily: 'gilroy',
                          fontSize: 16,
              ...
              Padding(
                ...
                child: Text('Current email', style: TextStyle(
                  fontFamily: 'gilroy',
                  fontWeight: FontWeight.w400,
                  fontSize: 13,
                  color: Color.fromRGBO(104, 104, 104, 1),
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(20.0, 8, 20, 8),
                child: Text('New Email', style: TextStyle(
                  fontFamily: 'gilroy',
                  fontWeight: FontWeight.w400,
                  fontSize: 13,
                  color: Color.fromRGBO(104, 104, 104, 1),
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        border: InputBorder.none,
                        icon: Image.asset('assets/icons/password.png', color: Color.fromRGBO(77, 77, 77, 1),),
                        label: Text('Enter new email',style: TextStyle(
                            fontFamily: 'gilroy',
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Color.fromRGBO(77, 77, 77, 1)
